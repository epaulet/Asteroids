(function () {
  ...
  GameView.prototype.renderGameOverScreen = function () {
    ...
    key('enter', function () {
      ...
      gameView.game = new Asteroids.Game(gameView.game.images);
      setTimeout(function() {
  ...
  GameView.prototype.renderTitleScreenContents = function () {
    ...
    ctx.drawImage(this.images.wormhole, 100, 125, 50, 50);
    ctx.drawImage(this.images.blackhole, 100, 225, 50, 50);
    ctx.drawImage(this.images.arrowKeys, 160, 350, 75, 50);
    ctx.drawImage(this.images.spaceBar, 550, 350, 75, 50);
    ctx.font = '24px sans-serif';
    ctx.fillStyle = 'white';
