(function () {
  ...
  Asteroids.Sounds = {
    ...
    lowToneSound: new Howl({ urls: ['./audio/low-tone.wav'], volume: 5 }),
    hiToneSound: new Howl({ urls: ['./audio/hi-tone.wav'], volume: 5 }),
    spaceThemeMusic: new Howl({ urls: ['./audio/spaceTheme.mp3'], loop: true, volume: 0.8 }),
    ...
    warp: function () {
      ...
      for(var i = 0; i < 4; i++) {
        ...
        lowDelay = hiDelay + 75;
        setTimeout(function () {
          sounds.hiToneSound.play();
        }, hiDelay);
        setTimeout(function () {
          sounds.lowToneSound.play();
        }, lowDelay);
      }
    }
  };
