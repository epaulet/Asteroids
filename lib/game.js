(function () {
  ...
  Game.INITIAL_ASTEROID_INTERVAL = 2000;
  Game.INITIAL_BLACKHOLE_LIMIT = 0;
  Game.INITIAL_BLACKHOLE_INTERVAL = 10000;
  Game.INITIAL_WORMHOLE_INTERVAL = 10000;
  ...
  Game.prototype.newLevelSetup = function () {
    this.points += level * 50000;
    this.level += 1;
    this.blackHoleLimit += 1;
    this.initialAsteroidCount += 2;
